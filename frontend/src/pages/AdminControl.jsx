...
import { 
  Settings, PlusCircle, Trash2, Edit, RefreshCw
} from 'lucide-react';
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 rounded-2xl bg-white p-6 border border-slate-200 shadow-sm">
        <div>
          <h1 className="text-xl font-bold text-slate-900 flex items-center gap-2">
            <Settings className="text-primary h-6 w-6" /> User Administration Console
          </h1>
          <p className="text-xs text-slate-500 mt-1 font-medium">
            Manage user accounts, system roles, and department assignments in real-time.
          </p>
        </div>
        <button 
          onClick={loadData}
